...
# # However, even 256x256 takes 40+ hours to train
export NCCL_P2P_DISABLE=1
accelerate launch --main_process_port 29501 src/train_cyclegan_turbo.py \
    --pretrained_model_name_or_path="stabilityai/sd-turbo" \
    --output_dir="output/cyclegan_turbo/Seed_Direction_4_24_no_prompt_384" \
    --dataset_folder "data/Seed_Direction_4_24_no_prompt" \
    --train_img_prep "resize_384" --val_img_prep "resize_384" \
